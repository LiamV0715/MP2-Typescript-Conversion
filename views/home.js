    ...
    return (<Default>
      <main style={{
        ...
        <div style={{
          ...
          <img src="https://plus.unsplash.com/premium_photo-1677545183884-421157b2da02?q=80&w=3272&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="A cat laying on a floor"/>
          Cat by Nathan Anderson on <a href="https://unsplash.com">unsplash</a>
        </div>

        {sections.map((section, index) => (<div key={index} style={{
                maxWidth: "2000px",
                maxHeight: "1000px",
                border: "1px solid black",
                margin: "2px",
